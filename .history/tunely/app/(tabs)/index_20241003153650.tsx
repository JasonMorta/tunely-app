...
import {placeholderImage} from '../../assets/images/placeholder-thumb.gif'; // Import a placeholder image
...
const Index: React.FC = () => {
  ...
  const renderItem = ({ item }: { item: any }) => (
    <Pressable style={styles.eventItem} onPress={() => openModal(item)}>
      <Image source={{ uri: (item.image ? item.image : placeholderImage) }} style={styles.eventImage} />
