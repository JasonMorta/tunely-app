    ...
    >
      ...
      <Tabs.Screen 
        ...
        options={{
          header: () => (
            <Image
              source={{ uri: 'https://your-image-url.com/home-image.png' }} // Replace with your image URL
      ...
      <Tabs.Screen 
        ...
        options={{
          header: () => (
            <Image
              source={{ uri: 'https://your-image-url.com/daily-image.png' }} // Replace with your image URL
              style={{ width: 100, height: 50, alignSelf: 'center', marginTop: 10 }}
            />
          ),
          title: 'Daily',
      ...
      <Tabs.Screen 
        ...
        options={{
          header: () => (
            <Image
              source={{ uri: 'https://your-image-url.com/profile-image.png' }} // Replace with your image URL
              style={{ width: 100, height: 50, alignSelf: 'center', marginTop: 10 }}
            />
          ),
          title: 'Profile',
